        ...
        <div className="flex flex-col lg:flex-row gap-9 w-full h-auto lg:h-[70vh] items-center  relative  px-10  custom:px-20  custom:mt-0 py-16">
                <div className="w-full lg:w-1/2  custom:px-2 flex flex-col justify-center gap-3">
                    ...
                    <div className="py-2 border-l-8 border-l-red-600 pl-4">
                        <h1 className="text-xl md:text-2xl lg:text-4xl font-bold tracking-wide font-serif">Accelerate your article Publication with Us</h1>
                    </div>
                    <p className="text-wrap text-sm font-sans tracking-wide">
                ...
                <div className="w-full lg:w-1/2 flex flex-col items-center ">
                    <img className="custom:max-w-[450px] max-h-96 " src="/primespherepublication/Home/aboutpreviewsmall.webp" alt="prime sphere " loading="lazy" />
                </div>
        </div>
    )
}
