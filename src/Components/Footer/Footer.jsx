...
const Footer = () => {
    return (
        ...
        <footer
            ...
            <div class="container flex-col md:flex flex-row gap-3 items-center justify-between px-24 py-6">
                {/* <!-- Social media icons container --> */}
                <div class="mb-6 flex flex-row justify-center space-x-2">
                    <Link
                        href="#!"
                        type="button"
                        class="rounded-full hover:bg-red-500 hover:text-white bg-white p-3 uppercase leading-normal text-surface shadow-dark-3 shadow-black/30 transition duration-150 ease-in-out hover:shadow-dark-1 focus:shadow-dark-1 focus:outline-none focus:ring-0 active:shadow-1 dark:bg-neutral-700 dark:text-white"
      ...
      <div class="mb-6">
        ...
        <ul class="mb-0 list-none">
          ...
          <li>
            ...
            {/* <!-- Copyright section --> */}
            <div class="w-full bg-gray-500/10 p-4 text-center">
                © 2025 Copyright:
                <Link class="font-semibold" href="/"
                >Prime Sphere Publication</Link>
            </div>
        </footer>
