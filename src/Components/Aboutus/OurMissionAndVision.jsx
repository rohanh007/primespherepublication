    ...
    return (
        <div className="w-full px-6 md:px-16 py-8 md:py-12 bg-red-50 mt-4">
            ...
            <div className="py-2 border-l-4 border-l-red-600 pl-3 mb-6 ">
                <h1 className="text-2xl md:text-3xl font-bold text-black">Our Mission & Vision</h1>
            </div>

            {/* Content Section */}
            <div className="flex flex-col md:flex-row items-start gap-6 md:gap-12">
                {/* Mission Section */}
                <div className="flex-1 border-e-2 pr-5">
                    <div className="py-2 border-b-2 border-b-red-600 pl-3 mb-3 max-w-[250px] ">
                        <h2 className="text-xl md:text-2xl font-semibold text-black">Our Mission</h2>
                    </div>
                ...
                <div className="flex-1 ">
                    <div className="py-2 border-b-2 border-b-red-600 pl-3 mb-3 max-w-[250px] ">
                        <h2 className="text-xl md:text-2xl font-semibold text-black">Our Vision</h2>
                    </div>
                    <p className="text-base md:text-lg text-gray-700 leading-relaxed">
